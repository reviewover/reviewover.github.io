jQuery(document).ready(function() {
    ...
    var options = { videoId: 'TJkmc8-eyvE', start: 3, mute: true };
    jQuery('#video-bg').tubular(options);
    ...
    jQuery(function () {
        ...
        if (!mobile) {
            ...
            if( jQuery(".countdown-section").first().find(".countdown-amount").text().length > 2 ) {
                ...
                jQuery(".countdown").css('margin-left', '-42px');

            } else {

                jQuery(".countdown").css('margin-left', '-56px');
